...
form.addEventListener('submit', function(event){
	...
	if(validateFirstName() && 
		...
		setTimeout(function(){
			...
			text.appendChild(document.createTextNode(`Sign Up succcessful, welcome to femmechat ${name} `));
...
function containsCharacters(field, code){
	...
	switch(code){
		...
		//letters and numbers
			...
			case 3:
		//uppercase and lowercase number
			regEx = /(?=.*\d)(?=.*[a-z])(?=.*[A-Z])/;
